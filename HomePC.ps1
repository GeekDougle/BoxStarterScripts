...
#--- Setting up Windows ---
# executeScript "SystemConfiguration.ps1";  #disabled for now, as it enables sideloading which is a security risk
...
#executeScript "HyperV.ps1";  # disabled for now, as it is not needed for now
